...
namespace lpzrobots {
  ...
  class QConfigurator : public QMainWindow {
    ...
    private:
       ...
       */
      int addConfigurablesToGrid(const ConfigList& configList, QGridLayout* grid, QHash<QString, int>& configurableIndexMap, int configurableWidgetIndex = 0, int embeddingDepth = 0);
